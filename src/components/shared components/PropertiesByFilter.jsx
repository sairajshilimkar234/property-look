...
//           <div className="text-gray-900 divide-y divide-gray-600 border rounded-md bg-white p-4 shadow-sm">
...
// // Main Component with Filter
// const PropertiesByFilters = () => {
//   const { search } = useLocation();
//   const params = new URLSearchParams(search);

//   const selectedType = params.get("type")?.toLowerCase() || "";
//   const selectedInventory = params.get("inventory")?.toLowerCase() || "";
//   const selectedArea = params.get("area")?.toLowerCase() || "";
//   const selectedBudget = params.get("budget") || "";

//   const filteredProperties = properties.filter((property) => {
//     const matchesType = property.type?.toLowerCase().includes(selectedType);
//     const matchesInventory = property.inventory?.toLowerCase().includes(selectedInventory);
//     const matchesArea = property.location?.toLowerCase().includes(selectedArea);
//     const matchesBudget = selectedBudget
//       ? parseInt(property.budget.replace(/[^\d]/g, "")) <= parseInt(selectedBudget)
//       : true;

//     return matchesType && matchesInventory && matchesArea && matchesBudget;
//   });
...
// export default PropertiesByFilters;
